...
The Website Specification is a single source of truth for what a good website does. Ten categories, 171 pages, every item tagged with a status. It ships in three machine-readable forms: per-page Markdown, llms.txt / llms-full.txt, and an MCP server.
